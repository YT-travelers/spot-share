...
class RouteConverter
{
    ...
    public function convertRouteDetailRestaurant(RouteDetailRestaurant $routeDetailRestaurant): array
    {
        ...
        return [
            ...
            'restaurantMealKindDivName' => $routeDetailRestaurant->mealKind->div_key_name ?? null,
            'restaurantCost' => $routeDetailRestaurant->restaurant_cost,
            'restaurant' => [
                'restaurantId' => $restaurant->restaurant_id,
                'restaurantName' => $restaurant->restaurant_name,
                'cuisineGenreDiv' => $restaurant->cuisine_genre_div,
                'cuisineGenreDivName' => $restaurant->cuisineGenre->div_key_name ?? null,
                'restaurantKindDiv' => $restaurant->restaurant_kind_div,
                'restaurantKindDivName' => $restaurant->restaurantKind->div_key_name ?? null,
                'restaurantOpenTimeHours' => $restaurant->restaurant_open_time_hours,
                'restaurantOpenTimeMinutes' => $restaurant->restaurant_open_time_minutes,
                'restaurantCloseTimeHours' => $restaurant->restaurant_close_time_hours,
                'restaurantCloseTimeMinutes' => $restaurant->restaurant_close_time_minutes,
    ...
    public function convertRouteDetailHotel(RouteDetailHotel $routeDetailHotel): array
    {
        ...
        return [
            ...
            'hotelBreakfastYesNoDivName' => $routeDetailHotel->hotelBreakfastYesNo->div_key_name ?? null,
            'hotelDinnerYesNoDiv' => $routeDetailHotel->hotel_dinner_yes_no_div,
            'hotelDinnerYesNoDivName' => $routeDetailHotel->hotelDinnerYesNo->div_key_name ?? null,
            'hotelCost' => $routeDetailHotel->hotel_cost,
            'hotel' => [
                'hotelId' => $hotel->hotel_id,
                'hotelName' => $hotel->hotel_name,
                'hotelKindDiv' => $hotel->hotel_kind_div,
                'hotelKindDivName' => $hotel->hotelKind->div_key_name ?? null,
    ...
    public function convertRouteDetailActivity(RouteDetailActivity $routeDetailActivity): array
    {
        ...
        return [
            ...
            'activity' => [
                ...
                'activityOpenTimeHours' => $activity->activity_open_time_hours,
                'activityOpenTimeMinutes' => $activity->activity_open_time_minutes,
                'activityCloseTimeHours' => $activity->activity_close_time_hours,
                'activityCloseTimeMinutes' => $activity->activity_close_time_minutes,
